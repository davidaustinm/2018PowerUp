...
public class Sensors {
	...
	public void resetDriveEncoder() {
		...
		rightOffset = -1 * (rightEncoder.get());
		lastLeftEncoder = 0;
		lastRightEncoder = 0;
	}
	...
	public double getLeftPosition() {
		return (getLeftEncoder() - leftOffset) / RobotMap.ENCODER_TICKS_PER_INCH;
	}
	
	public double getRightPosition() {
		return (getRightEncoder() - rightOffset) / RobotMap.ENCODER_TICKS_PER_INCH;
	}
